                    ...
                    <div class="form-row">
                        <form role="form" method="post" id="form">
           	                <div class="form-group col-md-3">               	  
                                ...
                                <input type="hidden" id="usuId"  name="usuId"  class="form-control" value="<?php print_r($usuId->idUsuario);?>">
                                <input type="text"  required disabled id="usu"  name="usu"  class="form-control" value="<?php print_r($usuId->usuario);?>">
                            </div>               
                            <div class="form-group col-md-3">               	  
                                <label for="inputPassword4">Nuevo Password</label>
                                <!-- <input type="password"  required  id="pass"  name="pass"  class="form-control" value="<?php ?>"> -->
                                <input type="text"  required  id="pass"  name="pass"  class="form-control" value="<?php ?>">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                <label><br></label>
                                <button type="submit"  class="btn btn-success" style="Font-weight:700; text-transform:uppercase;" id="agr">Actualizar</button>
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).ready( function() {
    ...
    $("#form").on("submit",function (e) {
        ...
        request = $.ajax({            
            url:"<?php  echo base_url('Intranet/update_password')?>",
        ...
        request.done(function (response,textStatus,jqXHR){                            
            if (response !=null){
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    cadena += '<td><a href="#"><i class="fa fa-cog" aria-hidden="true"></i></a></td>';                
                    cadena += '</tr>';
                }               
